...
public class Swagger2Config {
    ...
    private ApiInfo webApiInfo() {
        return new ApiInfoBuilder()
                .title("web端课程微服务API")//大标题
                .description("此文档描述了web端课程微服务API")//详细描述
                .version("1.0")//版本
    ...
    public Docket adminApiConfig() {
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .select()//开启选择
                .paths(Predicates.and(PathSelectors.regex("/admin/.*")))//排除admin包下的所有接口方法
                .build();
    }
    private ApiInfo adminApiInfo() {
        return new ApiInfoBuilder()
                .title("admin端后台管理-课程微服务API")//大标题
                .description("此文档描述了admin端课程后台管理微服务API")//详细描述
                .version("1.0")//版本
